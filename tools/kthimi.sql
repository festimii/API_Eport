CREATE OR ALTER PROCEDURE dbo.Api_GetKthimiInvoiceLines_Pending
AS
BEGIN
    SET NOCOUNT ON;
    ...
    FROM dbo.Kthimi_FaturaTransfers f
    INNER JOIN dbo.Kthimi_InvoiceStatus s
        ON s.ID_Fatura = f.ID_Fatura
    INNER JOIN dbo.Kthimi_ProduktTransfers p
